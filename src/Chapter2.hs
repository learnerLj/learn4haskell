...
subList start end xs
  ...
  | otherwise = mytrim start (length xs - end -1)
    where
      mytrim point1 point2 = reverse $ drop point2 $ reverse $ drop point1 xs
...
firstHalf l = reverse $ drop (length l - div (length l) 2 ) $ reverse l
